...
"""Refuse P-as-forecast, HAND-as-FIRM, USGS-library-as-FIRM claims."""
...
def _schema() -> StateSchema:
    return StateSchema.from_specs(
        [
            ...
            ChannelSpec("usgs_as_firm", last_value, default=False),
...
def build_graph() -> StateGraph:
    g = StateGraph(_schema(), name="fim.claim_bans")
